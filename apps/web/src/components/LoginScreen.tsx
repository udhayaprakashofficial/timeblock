...
/**
 * Clerk-style auth card: Google (server OAuth redirect) + email/password.
 * Google uses /api/auth/google so JS origins are not required (avoids origin_mismatch).
 */
...
function AuthCard({
  ...
  const [error, setError] = useState<string | null>(() => {
    if (authError === 'google') return 'Google sign-in failed. Try again.';
