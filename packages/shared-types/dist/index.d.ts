...
export type EffortBadgeCategory = 'daily' | 'consistency' | 'focus' | 'insight';
export type EffortBadgeId = 'planner' | 'on_track' | 'day_closer' | 'focus_zone' | 'week_warrior' | 'steady_streak' | 'timekeeper' | 'record_keeper' | 'daily_learner' | 'consistency' | 'ai_spark';
